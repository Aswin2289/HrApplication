...
const useAddVehicle = () => {
      ...
      const assignVehicle = async (id, userId) => {
        ...
        try {
            ...
            console.error('Error assigning vehicle:', error.response ? error.response.data : error.message);
            throw error;
        }
    };
    ...
    const getVehicleDetails = async (id) => {
      ...
      try {
        ...
        console.error('Error getting vehicle details:', error.response? error.response.data : error.message);
        throw error;
      }
    };
